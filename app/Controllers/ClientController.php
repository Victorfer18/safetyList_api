...
class ClientController extends BaseController
{
    ...
    {
        $query =  $query = $this->db->table('client as CLI')
            ->select('CLI.client_id, CLI.client_parent, CLI.client_created, CLITYP.client_type_name, INF.info_name, PAR.client_id as parent_id')
            ...
            ->where('CLI.client_parent', $id_parent)->orderBy('INF.info_name', 'ASC');
